 ...
 * di else e B nel primo esempio. Mentre se si valuta da destra non servono
 * modifiche.
 *
 * In realtà gli operatori logici non servono :
 * Assumiamo che se B è valutato a true -> 1 e se false -> 0
 *
 *
 * then := B;
 * else := 1;
 *
 * while(then){C1; then:= 0; else:= 0}
 * while(else){C2; else:= 0;}
 * */
